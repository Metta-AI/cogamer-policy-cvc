...
from cvc_policy.channel import ChannelBus, ChannelStats
from cvc_policy.handle import CogBase, CogletHandle, Command
...
class Coglet:
    ...
    def link(self, src: CogletHandle, src_channel: str, dest: CogletHandle, dest_channel: str):
